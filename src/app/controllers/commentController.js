...
exports.postComment = async function (req, res) {
    ...
    try {
        ...
        try {
            ...
            // 댓글 insert
            const insertCommentQuery = `insert into Comments(UserIdx, VideoIdx, commentsText) values(?,?,?);`;
...
exports.commentList = async function (req, res) {
    ...
    try {
        ...
        try {
            ...
            select CommentsIdx, UserIdx, VideoIdx, commentsText, LikesCount, LikesStatus, CmtReplyCount
                    from Comments
                    where VideoIdx = ?
...
/**
 update : 2020.07.24
 07.comment get API = 댓글 10개 씩 page 조회
 **/
exports.updateComment = async function (req, res) {
    ...
    try {
        ...
        try {
            ...
            // 댓글 update
            const insertCommentQuery = `update Comments set CommentText = ? where CommentsIdx = ? and UserIdx = ? and VideoIdx = ?;`;
            await connection.beginTransaction();
